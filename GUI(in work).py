...
class App(Tk):
    ...
    def generate_random_points(self):
        self.points = [(random.uniform(-50, 50), random.uniform(-50, 50)) for _ in range(10)]
        self.update_plot()
    ...
    def create_widgets(self):
        ...
        Entry(self.frame_params).pack(fill='x', padx=5, pady=(0, 5))
        ...
        Label(self.frame_params, text="Число квадратов (M):", bg="lightgray").pack(anchor='w', padx=5, pady=(5, 0))
        Entry(self.frame_params).pack(fill='x', padx=5, pady=(0, 5))
